<div id="vueForm" class="row" style="opacity: 0">
    <form method="POST" class="text-start"  v-on:submit.prevent="onSubmit">
        ...
        <x-forms.input type="countries" label="country_id" name="country_id" class="" value="" />
        <x-forms.input type="cities" label="city_id" name="city_id" class="" value="" />
        <x-forms.input type="towns" label="town_id" name="town_id" class="" value="" />
